 ...
 * 
 * 08/10/20 - So far I have a working irradiance monitor that displays current irradiance to its onboard OLED effectively.
 ...
 * 09/10/20 - Migrated project to platformio and broke it into a bunch of sub files
 * 10/10/20 - Migrated source files to GitHub managed.
 * 
 */
